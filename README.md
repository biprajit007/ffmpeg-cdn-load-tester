# ffmpeg-cdn-load-tester

Simulate many HLS/DASH viewers for CDN testing.
...
### Example
```bash
docker compose run --rm ffmpeg-tool python app.py --dry-run hls://example.com/live/index.m3u8 --viewers 25
```
